...
public class EditProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.merchant_activity_edit_profile);

        storageReference = FirebaseStorage.getInstance().getReference("profile pic");
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Merchant");
        ...
        picProfile = findViewById(R.id.profPic);
            ...
            public void onSuccess(final UploadTask.TaskSnapshot taskSnapshot) {
                imgref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        Toast.makeText(EditProfile.this, "Updated ＼(^o^)／ ", Toast.LENGTH_SHORT).show();
